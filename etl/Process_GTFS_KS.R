...
#Import trips tbl
trips <- read_csv("trips.csv", col_types = 
                   cols(
...
#Import stops table
stops <- read_csv("stops.csv", col_types = 
                   cols(
                     stop_id = col_character(),
...
#Import routes tbl
routes <- read_csv("routes.csv", col_types = 
                    cols(
                      route_id = col_character(),
                      agency_id = col_character(),
...
#Import calendar tbl
calendar <- read_csv("calendar.csv", col_types = 
                      cols(
                        service_id = col_integer(),
                        monday = col_integer(),
                        tuesday = col_integer(),
...
#Import agency tbl
agency <- read_csv("agency.csv", col_types = 
                     cols(
                       agency_id = col_character(),
