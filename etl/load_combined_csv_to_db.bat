rem set GTFS_SOURCE_DIR=C:\temp\RegionalTransitDatabase\data\gtfs\
...
rem Load into DB
rem setup pyodbc and connect to db directly
...
csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%routes.csv" -e WINDOWS-1252
csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%trips.csv" -e WINDOWS-1252
rem csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%stops.csv" -e WINDOWS-1252
rem csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%agency.csv" -e WINDOWS-1252
rem csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%calendar.csv" -e WINDOWS-1252
rem csvsql --db "mssql+pyodbc://%RTDLOGIN%:%RTDPASSWORD%@localhost:1433/RTD_2017?driver=ODBC+Driver+11+for+SQL+Server;BoolsAsChar=0" --insert "%GTFS_SOURCE_DIR%shapes.csv" -e WINDOWS-1252
