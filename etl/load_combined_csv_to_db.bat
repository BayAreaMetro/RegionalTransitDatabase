...
ren %GTFS_SOURCE_DIR%routes.csv routes_back.csv
csvcut -C "route_text_color","route_color" %GTFS_SOURCE_DIR%routes_back.csv > %GTFS_SOURCE_DIR%routes.csv -e WINDOWS-1252
del %GTFS_SOURCE_DIR%routes_back.csv
...
rem head -n 15000 "%GTFS_SOURCE_DIR%routes.csv" | csvsql -i mssql -e WINDOWS-1252 > create_routes_table.sql
rem head -n 15000 "%GTFS_SOURCE_DIR%trips.csv" | csvsql -i mssql -e WINDOWS-1252 > create_trips_table.sql
rem head -n 15000 "%GTFS_SOURCE_DIR%stops.csv" | csvsql -i mssql -e WINDOWS-1252 > create_stops_table.sql
rem head -n 10 "%GTFS_SOURCE_DIR%agency.csv" | csvsql -i mssql -e WINDOWS-1252 > create_agency_table.sql
rem head -n 2000 "%GTFS_SOURCE_DIR%calendar.csv" | csvsql -i mssql -e WINDOWS-1252 > create_calendar_table.sql
rem head -n 4000 "%GTFS_SOURCE_DIR%shapes.csv" | csvsql -i mssql -e WINDOWS-1252 > create_shapes_table.sql
rem head -n 15000 "%GTFS_SOURCE_DIR%stop_times.csv" | csvsql -i mssql -e WINDOWS-1252 > create_stop_times_table.sql
