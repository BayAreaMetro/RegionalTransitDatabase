...
GO
		...
		SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(AM_Peak_Monday_Total_Trips) AS [Max AM Trips], MIN(Monday_AM_Peak_Headway) AS [Min AM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
		into #Monday_AM_Peak_Trips_15min_or_Less
		FROM   #Monday_AM_Peak_Transit_Stop_Headways
		GROUP BY agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, stop_lon, stop_lat
...
GO
	...
	SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(PM_Peak_Monday_Total_Trips) AS [Max PM Trips], MIN(Monday_PM_Peak_Headway) AS [Min PM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
		...
		SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(AM_Peak_Tuesday_Total_Trips) AS [Max AM Trips], MIN(Tuesday_AM_Peak_Headway) AS [Min AM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
	...
	SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(PM_Peak_Tuesday_Total_Trips) AS [Max PM Trips], MIN(Tuesday_PM_Peak_Headway) AS [Min PM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
		...
		SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(AM_Peak_Wednesday_Total_Trips) AS [Max AM Trips], MIN(Wednesday_AM_Peak_Headway) AS [Min AM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
	...
	SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(PM_Peak_Wednesday_Total_Trips) AS [Max PM Trips], MIN(Wednesday_PM_Peak_Headway) AS [Min PM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
		...
		SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(AM_Peak_Thursday_Total_Trips) AS [Max AM Trips], MIN(Thursday_AM_Peak_Headway) AS [Min AM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
	...
	SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(PM_Peak_Thursday_Total_Trips) AS [Max PM Trips], MIN(Thursday_PM_Peak_Headway) AS [Min PM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
		...
		SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(AM_Peak_Friday_Total_Trips) AS [Max AM Trips], MIN(Friday_AM_Peak_Headway) AS [Min AM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
GO
	...
	SELECT agency_id, agency_name, route_id, agency_stop_id, stop_name, status, system, TPA, MAX(PM_Peak_Friday_Total_Trips) AS [Max PM Trips], MIN(Friday_PM_Peak_Headway) AS [Min PM Headway], COUNT(agency_stop_id) AS [Route Patterns], stop_lon, stop_lat
...
--Top(100) 
* from [dbo].[TPA_Transit_Stops_2016_Build])
select OD.agency_stop_id, DDStops.agency_stop_id as dd_stop_id, OD.system, OD.Shape as OD_SHape, DDStops.Shape as DD_Shape
...
--select * From [dbo].[TPA_Transit_Stops_2016_Draft] where system <>'Bus' order by agency_id, route_id, status, system, stop_name -- Only Planned Transit