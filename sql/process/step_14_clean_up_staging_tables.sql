...
Drop Table [dbo].[stops_tpa_staging_headway_base_calculations]
...
--select * From [dbo].[stops_tpa_staging_headway_base_calculations_2016_Draft] where route_type <>'Bus' order by agency_id, route_id, route_type, stop_name -- Only Planned Transit