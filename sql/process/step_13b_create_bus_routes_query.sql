SELECT        rtd_route_trips.agency_id, rtd_route_trips.agency_name, rtd_route_trips.route_id, rtd_route_trips.direction_id, stops.stop_name, 
                         ...
                         geometry::Point(stops.stop_lon, stops.stop_lat, 4326) AS SHAPE, STOPS_NETWORK_LOCATIONS.SourceID, STOPS_NETWORK_LOCATIONS.SourceOID, 
...
INTO              RTD_2016_Route_Pattern_Bus_Stop_Schedule
FROM            stops INNER JOIN
                         ...
                         calendar ON rtd_route_trips.agency_service_id = calendar.agency_service_id INNER JOIN
                         STOPS_NETWORK_LOCATIONS ON stops.agency_stop_id = STOPS_NETWORK_LOCATIONS.agency_stop_id
WHERE        (rtd_route_trips.route_type = 3)

alter table RTD_2016_Route_Pattern_Bus_Stop_Schedule
...
INTO RTD_2016_Route_Pattern_Bus_Stops
FROM            RTD_2016_Route_Pattern_Bus_Stop_Schedule
...
alter table RTD_2016_Route_Patternn_Stops
add OBJECTID int IDENTITY(1,1) NOT NULL,
